<div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Laporan Data Order</h3>
            </div>
            <div class="box-header">
           	<?php echo form_open('order/laporan', array('id' => 'FormLaporan')); ?>
           	 <!-- Date range -->
...
$(document).ready(function(){	
	...
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('order/aksi_laporan'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});
