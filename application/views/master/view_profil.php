            ...
            <div class="panel-body">
              <?php if ($message == 'ok'):?>
                <div class="alert alert-success">
                  <p>Profil telah diperharui</p>
                </div>
              <?php endif;?>
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img width="100" height="100" alt="User Pic" src="<?php echo base_url('Admin/images/staff/'.$row->foto);?>" class="img-circle img-responsive"> </div>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  ...
                  <a href="<?php echo site_url();?>profil/edit" class="btn btn-primary">Edit Profil</a>
    ...
    function edit_bid(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
			...
			$('[name="gambar"]').val(data.foto);
			$('[name="filelama"]').val(data.foto);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data" onSubmit="save()">
			      <input type="hidden" value="" name="id_admin"/>
		          <table class="table table-form">
             	<tr><label for="user"><td style="width: 25%">Username</td></label>
                <td style="width: 35%"><input type="text" id="user" name="user" class="form-control" required="required" ></td></tr>
                ...
                <tr><label for="foto"><td style="width: 25%">Foto</td></label>
                <td style="width: 35%">
                	<input type="hidden" name="filelama" value="" />
                	<input type="file" id="gambar" name="gambar" class="form-control">
                	*)Upload Foto Max 512 Kb
                </td></tr>                
      		</table>
      </div>
