    ...
    $(function(){
        ...
        $("#simpan").click(function(){
            ...
            if (per=="") {
                ...
                alert("Data Keterangan Belum di Pilih");
                return false;
            }else if (ket=="") {
                alert("Data Keterangan Transfer Belum di Pilih");
                return false;
            }else{
                $.ajax({
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<div class="form-group">
									...
									<div class="input-group date">
					                  ...
					                  <input id="per" name="per" type="text" class="form-control pull-right">
					                </div>  
								</div>
								<div class="form-group">
									<label>Rincian Pembayaran</label>
                                    <select id="rinc" name="rinc" class="form-control" >
                                        ...
                                        <option value="Pembelian Kaos /Seragam">Pembelian Kaos /Seragam</option>
                                        <option value="Biaya Umum dan Dokumen">Biaya Umum dan Dokumen</option>
                                    </select>
								</div>
								<div class="form-group">
									<label>Keterangan Transfer</label>
                                    <select id="ket" name="ket" class="form-control" data-validation="required" >
                                        <option value="">-- Pilih Transfer --</option>
                                        <option value="Transfer Ke Ika <0610459074>">Transfer Ke Ika <0610459074></option>
                                        <option value="Transfer Ke Irma <0377160828>">Transfer Ke Irma <0377160828></option>
                                        <option value="Transfer Ke Ichan <0610458752>">Transfer Ke Ichsan <0610458752></option>
                                        <option value="Transfer Ke Rizky <0488717067>">Transfer Ke Rizky <0488717067></option>
                                        <option value="Transfer Ke Gilang <0583485820>">Transfer Ke Gilang <0583485820></option>
