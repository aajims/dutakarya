 <section class="content">
   	<div class="box box-default">
   	  <form method="post" action="<?php echo site_url(); ?>ppu/updatec" method="post" >
		<div class="row">
						  ...
						  <div class="panel-body">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="form-group">
									<label>No PPU</label>
									<input type="hidden" name="kode" value="<?php echo $ppu->kode; ?>" />
                                    <input type="hidden" name="email" value="<?php echo $ppu->email; ?>" />
							 ...
							 <div class="col-md-6 col-sm-6 col-xs-6">	
								...
								<div class="form-group">
									...
									<div class="input-group date">
					                  ...
					                  <input name="tgls" type="text" readonly="" class="form-control pull-right" id="datepicker">
					                </div>
								</div>
								<div class="form-group">
									...
									<?php
										if ($ppu->status == 'Di ajukan') {
											echo "<div class='segmented-control' style='width: 70%; color: #000AAC'>
								...
								<div class="form-group">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <?php
                                     if ($ppu->sts == '') {
                                         echo "<div class='segmented-control' style='width: 70%; color: #0000ff'>
											  <input type='radio' name='sts' value='hold' id='hold' checked=''>
											  <input type='radio' name='sts' value='Done' id='Done'>
											  <label for='hold' data-value='hold'>Hold</label>
											  <label for='Done' data-value='Done'>Done</label>
											</div>";
                                     }  else {
                                         echo "<div class='segmented-control' style='width: 70%; color: #0000ff'>
											  <input type='radio' name='sts' value='hold' id='hold'>
											  <input type='radio' name='sts' value='Done' id='Done' checked=''>
											  <label for='hold' data-value='hold'>Hold</label>
											  <label for='Done' data-value='Done'>Done</label>
											</div>";
                                     }
