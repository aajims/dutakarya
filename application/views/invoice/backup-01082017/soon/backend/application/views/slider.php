                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url()."Slider/Setstatus/".$gallery_slider[$i]['id']."/".$arrStatus[$gallery_slider[$i]['status']]['setstatus'];;?>" class="btn btn-sm <?php echo $arrStatus[$gallery_slider[$i]['status']]['color'];?>">Set <?php echo $arrStatus[$gallery_slider[$i]['status']]['labelButton'];?></a>
                          <a href="<?php echo base_url()."Slider/Edit/".$gallery_slider[$i]['id'];?>" class="btn btn-primary">Edit</a>
