          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <form role="form" action="<?php echo base_url()."Promo/AddKategori";?>" method="post" name="form1">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        <td><?php echo ($i+1);?></td>
                        <td><?php echo $kategori[$i]->kategori;?></td>
                        <td><a class="btn btn-info" href="<?php echo base_url().'Promo/DetailKategori/'.$kategori[$i]->id;?>">Detail</a></td>
                    <?php
                          $i++;
                        }
                      }
