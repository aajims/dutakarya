            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <a class="btn btn-info" href="<?php echo base_url()."Section/SectionSlider/".$page[0]->id;?>">Slider</a>
                  <a class="btn btn-warning" href="<?php echo base_url()."Mini/SectionMiniSlider/".$page[0]->id;?>">Mini Slider</a>
                  <a class="btn btn-success" href="<?php echo base_url()."Section/SectionHtml/".$page[0]->id?>">HTML</a>                   
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
