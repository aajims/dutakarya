              ...
              <div class="box">
                <div class="box-body">
                  <h3>Page : <strong><?php echo $page[0]->page;?></strong></h3>
                   <form role="form" action="<?php echo base_url().'Section/UpdateSection';?>" method="post">
                      <input type="hidden" name="section_bg_images" id="section_bg_images" value="<?php echo $section_detail[0]->background;?>"/>
                      <input type="hidden" name="sections_background_type" id="sections_background_type" value="<?php echo $section_detail[0]->bg_type;?>"/>
                      <input type="hidden" name="section_images" id="section_images" value="<?php echo $section_detail[0]->images;?>"/>
                      ...
                      <input type="hidden" name="section_id_section" id="section_id_section" value="<?php echo $section_detail[0]->id;?>"/>
					            <input type="hidden" name="section_gif_value" id="section_gif_value" value="<?php echo $section_detail[0]->gif;?>"/>
                      <input type="hidden" name="section_slider_icon" id="section_slider_icon" value="<?php echo $section_detail[0]->icon;?>"/>
                      <div class="box-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Title (maks 32 karakter)</label>
                          <input type="text" class="form-control" id="sections_title" name="sections_title" maxlength="64" value="<?php echo $section_detail[0]->title;?>" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Title (maks 32 karakter) English Version</label>
                          <input type="text" class="form-control" id="sections_title_en" name="sections_title_en" maxlength="64" value="<?php echo $sectiondetail_en[0]->title;?>" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Background Type</label>
                          <select class="form-control" onchange="setBg()" id="sections_background_type" name="sections_background_type" value="<?php echo $section_detail[0]->bg_type;?>">
                            <option value="C" <?php echo $color_selected; ?> >Color</option>
                            <option value="I" <?php echo $bgimg_selected; ?> >Image</option>
                          </select>
                        </div>
                        <div class="form-group" id="bg_color">
                          <label for="exampleInputPassword1">Color</label>
                          <input class="form-control jscolor" id="sections_background_color" name="sections_background_color" value="<?php echo $section_detail[0]->background;?>" required />
                        </div>

                        <div class="form-group">
                          <label for="exampleInputPassword1">Class Attribute</label>
                          <input type="text" class="form-control" id="form_slider_class" value="<?php echo $section_detail[0]->sec_class;?>" name="form_slider_class" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Description (maks 64 karakter)</label>
                          <textarea id="editor1" name="sections_description" rows="10" cols="80"><?php echo $section_detail[0]->description;?></textarea>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Description (maks 64 karakter) English Version</label>
                          <textarea id="editor2" name="sections_description_en" rows="10" cols="80"><?php echo $sectiondetail_en[0]->description;?></textarea>
                        </div>  
                    ...
                    <form id="section_form_background_images" name="section_form_background_images" enctype="multipart/form-data">              
                        <div class="form-group" id="bg_img">
                          ...
                          <div id="section_background_images_preview"><?php echo $html_bg;?></div>
                        </div>
                    </form><br><br>
                    <form id="section_form_upload_images" name="section_form_upload_images" enctype="multipart/form-data">
                        <div class="form-group">
                          ...
                          <div id="section_images_preview" name="sections_images_preview"><?php echo $html_images;?></div><br>
						  <?php if ( $html_images !== "" ) { ?>
						  <input type="checkbox" name="sections_images_gif_checkbox" id="sections_images_gif_checkbox" onclick="setGif();" checked/>Gif
						  <?php } else { ?>
                    ...
                    <form id="form_slider_submit_icon" name="form_slider_submit_icon" enctype="multipart/form-data">
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <div id="form_slider_icon_preview"><?php echo $html_icon;?></div>
                        </div>                    
                      </div>
                    </form>
