          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <form role="form" action="<?php echo base_url()."Slider/UpdateSlider";?>" method="post" name="form1">
                  ...
                  <input type="hidden" name="form_slider_icon" id="form_slider_icon" value= "<?php echo $slider_detail[0]->icon;?>" />

                  <input type="hidden" name="form_slider_type" id="form_slider_type" value="<?php echo $slider_detail[0]->type;?>" required />

                  <input type="hidden" name="form_slider_gif" id="form_slider_gif" value="<?php echo $slider_detail[0]->gif;?>"/>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form_slider_title" name="form_slider_title"  maxlength="500" value="<?php echo $slider_detail[0]->title; ?>">

                    </div>

                    <div class="form-group">

                      <label for="exampleInputEmail1">Title ( maks 500 karakter ) English Version</label>

                      <input type="text" class="form-control" id="form_slider_title_en" name="form_slider_title_en"  maxlength="500" value="<?php echo $slider_detail_en[0]->title; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="form_slider_karakter" name="form_slider_karakter" required><?php echo $slider_detail[0]->content; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="form_slider_karakter_en" name="form_slider_karakter_en" required><?php echo $slider_detail_en[0]->content; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form_slider_url" name="form_slider_url" value="<?php echo $slider_detail[0]->links; ?>">
                    ...
                    <div class="form-group" id="bg_color">
                      ...
                      <input class="form-control jscolor" id="form_slider_background_color" name="form_slider_background_color" value="<?php echo $slider_detail[0]->background; ?>"/>
                    ...
                    <div class="form-group" id="bg_color">
                      ...
                      <input type = "text" class="form-control" id="form_slider_class" name="form_slider_class" value="<?php echo $slider_detail[0]->sec_class; ?>"/>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" id="form_slider_photo" name="form_slider_photo" value="<?php echo $slider_detail[0]->img;?>">
