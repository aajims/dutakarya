                                ...
                                <tbody>
                                  <tr>
                                    <td class='movableContentContainer'>
                                        <div class='movableContent' style='border: 0px; padding-top: 0px; position: relative;background-color: #810c8c;' >
                                          <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                            <tbody>
                                              <tr>
                                                <td height='15'></td>
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td valign='top' width='60'>
                                                                  <img src='<?php echo base_url();?>assets/dist/img/logo_paypro.png' alt='Logo' title='Logo' width='60' height='60' data-max-width='100' style='padding-left: 10px;'>
                                                                </td>
                                                  ...
                                                  <tr>
                                                    <td valign='top' width='580'>
                                                      ...
                                                      <div class='contentEditable' style='text-align: center;'>
                                                          <img class='banner' src='<?php echo base_url().'assets/dist/img/newsletter/'.$newsletter_detail[0]->images;?>' alt='Logo' title='Logo' width='580' height='221' border='0'>
                                                      </div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                                  ...
                                                                  <tr>
                                                                    <td>
                                                                      <div class='contentEditableContainer contentTextEditable'>
                                                                        <div class='contentEditable' style='text-align: center;'>
                                                                          <h2 style='font-size: 20px;'><?php echo $newsletter_detail[0]->title; ?></h2>
                                                                          <br>
                                                                          <?php echo $newsletter_detail[0]->content;?>
                                                                        </div>
                                                                      </div>
                                                                    </td>
                                                                  </tr>
                                                                ...
                                                                <tr>
                                                                    <td width='40'>
                                                                      <div class='contentEditableContainer contentFacebookEditable'>
                                                                        <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                          <img src='<?php echo base_url();?>assets/dist/img/facebook.png' alt='facebook' width='40' height='40' data-max-width='40' data-customIcon='true' border='0' >
                                                                        </div>
                                                                      </div>
                                                                    </td>
                                                                    <td width='10'></td>
                                                                    <td width='40'>
                                                                      <div class='contentEditableContainer contentTwitterEditable'>
                                                                        <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                          <img src='<?php echo base_url();?>assets/dist/img/twitter.png' alt='twitter' width='40' height='40' data-max-width='40' data-customIcon='true' border='0'>
                                                                        </div>
                                                                      </div>
                                                                    </td>
                                                                  </tr>
