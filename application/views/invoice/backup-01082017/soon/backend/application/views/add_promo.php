              ...
              <div class="box">
                <div class="box-body">
                   <form role="form" action="<?php echo base_url().'Promo/SavePromo';?>" method="post">
                      <input type="hidden" name="promo_method" id="promo_method" value="add"/>
                      <input type="hidden" name="promo_id" id="promo_id" value="<?php echo $promoid;?>"/>
                      <input type="hidden" name="promo_kategori" id="promo_kategori" value="<?php echo $idkategori;?>"/>
                      <input type="hidden" name="promo_images" id="promo_images"/>
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="sections_title_en" name="sections_title_en" maxlength="64"/>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Intro (maks 256 karakter)</label>
                          <input type="text" class="form-control" id="sections_intro" name="sections_intro" maxlength="256" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Intro (maks 256 karakter) English Version</label>
                          <input type="text" class="form-control" id="sections_intro_en" name="sections_intro_en" maxlength="256"/>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                        <form id="promo_form_upload_images" name="promo_form_upload_images" enctype="multipart/form-data">
                          ...
                          <div id="promo_images_preview" name="promo_images_preview"></div>
                          </form>
                        </div>
                      </div><!-- /.box-body -->
