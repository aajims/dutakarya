            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a href="<?php echo base_url()."Mini/MiniSliderList/".$id_page."/".$id_sections;?>" class="btn btn-info">Kembali Ke Gallery Slider</a>
                  <a href="<?php echo base_url()."Section/PageSections/".$id_page;?>"" class="btn btn-success">Kembali Ke Page</a><br><br>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="<?php echo base_url()."Mini/RemoveSectionSlider/".$gallery_slider[$i]['id']."/".$id_sections."/".$id_page;?>" class="btn btn-warning">Remove from this Section</a></td>
                    <?php
                          $i++;
                        }
                      }
