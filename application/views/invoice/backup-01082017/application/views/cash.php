...
<html class=" inlinesvg backgroundcliptext" lang="en">
    ...
    <title>How to Cash Out - PayPro Service Type</title>
...
<header class="site-header js-app-header">
  <div class="site-header__wrapper">
    <h1 class="site-title">
    <a href="http://paypro.id/backup-programming/" class="site-title__logo" data-internal-link>
    ...
    <div class="content-body">
      <div class="content-body__wrapper">
        ...
        <div class="content-findoutmore sticker">
        	...
        	<p>PayPro balance can be cashed out at the following entity:</p>
			<div class="logo-how-cash">
            	<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/alfamart.png" width="150" style="margin-right:30px">
				<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/logo-indomaret.png" width="200">
			</div>
            
            <h4>How to Cash Out Balance</h4>
            <ol>
                <li>Go to the nearest Alfamart/Indomaret. </li>
                <li>Access PayPro apps and click Cash Out menu then click “GENERATE TOKEN”.</li>
				<li>Inform the amount of money to be cashed out to the cashier.</li>
				<li>Inform Paypro account number and token number. </li>
				<li>Cashier will input PayPro account and amount of money to be cashed out to the system. </li>
				<li>PayPro balance will be automatically deducted and customer will get success notification report on the sms.</li>
				<li>Customer receives cash money from the cashier. </li>
            </ol>
			
			<hr style="padding-bottom: 0 !important; margin-top: 40px !important; margin-bottom: 0 !important;">
			
			<h4>Withdraw Money Transfer (Wallet-to-Cash)</h4>
			<p>Balance received from wallet-to-cash money transfer service can be cashed out at following entity: </p>
			<div class="logo-how-cash">
            	<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/alfamart.png" width="150" style="margin-right:30px">
				<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/logo-indomaret.png" width="200">
			</div>
            ...
            <ol>
                <li>Go to the nearest Alfamart/Pegadaian.</li>
                <li>Inform the cashier for withdraw money transfer from PayPro. </li>
				<li>Inform the MTCN (Money Transfer Control Number) that you receive from Sender. </li>
				<li>Show your valid ID Card to cashier. </li>
				<li>After the transaction is verified, customer receives cash money from the cashier.</li>
            </ol>			
        </div>
...
<script>
    ...
    $(window).scroll(function(){
        ...
        if(img1Top && changed != 1){
            $('.wrap').attr('src','<?php echo base_url();?>/wrap.gif');
            changed++;
        };
        ...
        if(top==(img2Top) && changed != 2){
            $('.vest').attr('src','<?php echo base_url();?>/vest.gif');
            changed++;
        };
    
        var img3Top = $('.loop').offset().top;
        if(top==(img3Top) && changed != 3){
            $('.loop').attr('src','<?php echo base_url();?>/loop.gif');
            changed++;
        };
