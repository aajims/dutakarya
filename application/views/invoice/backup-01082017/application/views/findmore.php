    ...
    <div class="content-body">
      <div class="content-body__wrapper">
        ...
        <div class="content-findoutmore">
            ...
            <ul>
                <li><i class="fa fa-circle-o"></i>Visit the nearest Gerai Indosat.</li>
                <li><i class="fa fa-circle-o"></i>Indicate the amount of money you want to cash-in/top-up.</li>
                <li><i class="fa fa-circle-o"></i>The cashier will input your mobile number/PayPro ID and the amount of money into the system</li>
                <li><i class="fa fa-circle-o"></i>Your PayPro balance will automatically increase and you will receive an SMS notification and receipt.</li>
            </ul>-->
            
            <h4>Alfamart/Alfamidi/Dan+Dan</h4>
            <ul>
                <li><i class="fa fa-circle-o"></i>Visit the nearest Alfamart/Alfamidi/Dan+Dan outlet.</li>
                <li><i class="fa fa-circle-o"></i>Inform the cashier the amount of money you want to cash-in/top-up.</li>
                <li><i class="fa fa-circle-o"></i>The cashier will input your mobile number/PayPro ID, token number, and the amount of money into the system.</li>
                <li><i class="fa fa-circle-o"></i>Your PayPro balance will automatically increase and you will receive an SMS notification and receipt from the store.</li>
            </ul>
            
            <h4>Indomaret</h4>
            <ul>
                <li><i class="fa fa-circle-o"></i>Visit the nearest Indomaret outlet.</li>
                <li><i class="fa fa-circle-o"></i>Access *123# or open PayPro app and click &quot;request token.&quot;</li>
                <li><i class="fa fa-circle-o"></i>Inform the cashier the amount of money you want to cash-in/top-up.</li>
                <li><i class="fa fa-circle-o"></i>Give your mobile number/PayPro ID and token number.</li>
                <li><i class="fa fa-circle-o"></i>The cashier will input your mobile number/PayPro ID, token number, and the amount of money into the system.</li>
                <li><i class="fa fa-circle-o"></i>Your PayPro balance will automatically increase and you will receive an SMS notification and receipt from Indomaret.</li>
            </ul>
            
            <h4>ATM Bersama</h4>
            <ul>
                <li><i class="fa fa-circle-o"></i>On the menu choose &quot;Transfer to other bank accounts&quot;</li>
                <li><i class="fa fa-circle-o"></i>Insert the bank code &quot;789&quot; and your mobile number/PayPro ID as the destination number.</li>
                <li><i class="fa fa-circle-o"></i>Your PayPro balance will automatically increase and you will receive an SMS notification and receipt.</li>
            </ul>
        </div>
