...
<html class=" inlinesvg backgroundcliptext" lang="en">
    ...
    <title>List of PayPro Merchant </title>
  ...
  <article class="content content--news-detail news-detail typeset promos-detail">
    ...
    <div class="content-body">
      <div class="content-body__wrapper">
        ...
        <div class="main-serviceType pb-80">
   
            <section id="single" data-accordion>
              <button data-control><?php echo $words[23];?></button>
              <div data-content>
                <article>
                    <div class="table-promosDetail">
                        <table>
                            <!--<thead>
                                <tr>
                                    <th><?php echo $words[23];?></th>
                                    <th><?php echo $words[24];?></th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $merchant[$i]['merchant'];?></td>
							...
							<tbody>
								<tr style="border: 1px solid #666;">
									<td style="border-right: 1px solid #666; vertical-align: middle; padding: 15px 0 15px 15px;">
										<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/alfamart.png" width="140"/>
									</td>
									<td style="vertical-align: middle; padding: 15px 0 15px 15px;">
										<p>PayPro can be used to purchase your daily needs at Alfamart.</p>
										<a href="http://paypro.id/Promo/DetailPromo/8" target="_blank" class="btn-merchant">How To Purchase at Alfamart</a>
									</td>
								</tr>
								<tr style="border: 1px solid #666;">
									<td style="border-right: 1px solid #666; vertical-align: middle; padding: 15px 0 15px 15px;">
										<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/indomaret.png" width="140"/>
									</td>
									<td style="vertical-align: middle; padding: 15px 0 15px 15px;">
										<p>PayPro can be used to purchase your daily needs at Indomaret.</p>
										<a href="http://paypro.id/Promo/DetailPromo/9" target="_blank" class="btn-merchant">How To Purchase at Indomaret</a>
									</td>
								</tr>
								<tr style="border: 1px solid #666;">
									<td style="border-right: 1px solid #666; vertical-align: middle; padding: 15px 0 15px 15px;">
										<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/dimo-merchant.JPG" width="60"/>
									</td>
									<td style="vertical-align: middle; padding: 15px 0 15px 15px;">
										<p>PayPro accepted at DIMO merchant. Ongoing promotion by DIMO is applied to PayPro.</p>
										<a href="https://www.dimo.co.id/id/dimo" target="_blank" class="btn-merchant">List of DIMO Merchant</a>
									</td>
								</tr>
								<tr style="border: 1px solid #666;">
									<td style="border-right: 1px solid #666; vertical-align: middle; padding: 15px 0 15px 15px;">
										<img src="<?php echo base_url();?>assets/files/templates/riiot/public/assets/images/dealoka.png" width="100"/>
									</td>
									<td style="vertical-align: middle; padding: 15px 0 15px 15px;">
										<p>PayPro accepted at Dealoka merchant. Ongoing promotion by DIMO is applied to PayPro.</p>
										<a href="http://www.dealoka.com/" target="_blank" class="btn-merchant">List of Dealoka Merchant</a>
									</td>
								</tr>
							</tbody>
                        </table>
