...
this.env.source){for(n in this.env.address_sources)break;this.env.source=n;this.env.group=""}this.list_contacts(this.env.source,this.env.group,1)}break;case "pushgroup":var p={id:b.id,search_request:this.env.search_request,page:this.env.current_page,search:this.env.search_request&&this.gui_objects.qsearchbox?this.gui_objects.qsearchbox.value:null};this.env.address_group_stack.push(p);d&&e&&rcube_event.cancel(e);case "listgroup":this.reset_qsearch();this.list_contacts(b.source,b.id,1,p);break;case "popgroup":this.env.address_group_stack.length&&
(e=this.env.address_group_stack.pop(),this.reset_qsearch(),e.search_request?(e.search&&this.gui_objects.qsearchbox&&$(this.gui_objects.qsearchbox).val(e.search),this.env.search_request=e.search_request,this.list_contacts_remote(null,null,this.env.current_page=e.page)):this.list_contacts(b.source,this.env.address_group_stack[this.env.address_group_stack.length-1].id));break;case "import-messages":e=b||this.gui_objects.importform;h=this.set_busy(!0,"importwait");$('input[name="_unlock"]',e).val(h);
(e=this.upload_file(e,"import",h))||(this.set_busy(!1,null,h),!1!==e&&alert(this.get_label("selectimportfile")),l=!0);break;case "import":if("import"==this.env.action&&this.gui_objects.importform){if((e=document.getElementById("rcmimportfile"))&&!e.value){alert(this.get_label("selectimportfile"));l=!0;break}this.gui_objects.importform.submit();this.set_busy(!0,"importwait");this.lock_form(this.gui_objects.importform,!0)}else this.goto_url("import",this.env.source?"_target="+urlencode(this.env.source)+
"&":"");break;case "export":0<this.contact_list.rowcount&&this.goto_url("export",{_source:this.env.source,_gid:this.env.group,_search:this.env.search_request},!1,!0);break;case "export-selected":0<this.contact_list.rowcount&&this.goto_url("export",{_source:this.env.source,_gid:this.env.group,_cid:this.contact_list.get_selection().join(",")},!1,!0);break;case "upload-photo":this.upload_contact_photo(b||this.gui_objects.uploadform);break;case "delete-photo":this.replace_contact_photo("-del-");break;
case "preferences":case "identities":case "responses":case "folders":this.goto_url("settings/"+a);break;case "undo":this.http_request("undo","",this.display_message("","loading"));break;default:h=a.replace(/-/g,"_"),this[h]&&"function"===typeof this[h]&&(g=this[h](b,d,e))}l||!1!==this.triggerEvent("after"+a,b)||(g=!1);this.triggerEvent("actionafter",{props:b,action:a,aborted:l,ret:g});return!1===g?!1:d?!1:!0};this.enable_command=function(){var a,b,d=Array.prototype.slice.call(arguments),e=d.pop(),
g;for(b=0;b<d.length;b++)if(g=d[b],"string"===typeof g)this.commands[g]=e,this.set_button(g,e?"act":"pas"),this.triggerEvent("enable-command",{command:g,status:e});else for(a in g)d.push(g[a])};this.command_enabled=function(a){return this.commands[a]};this.set_busy=function(a,b,d){a&&b?(d=this.get_label(b),d==b&&(d="Loading..."),d=this.display_message(d,"loading")):!a&&d&&this.hide_message(d);this.busy=a;this.gui_objects.editform&&this.lock_form(this.gui_objects.editform,a);return d};this.gettext=
...
function(b,d){d&&!rcube_mouse_is_over(a,d.list.parentNode)&&d.blur()});if(this.buttons_sel){for(b in this.buttons_sel)"function"!==typeof b&&this.button_out(this.buttons_sel[b],b);this.buttons_sel={}}setTimeout(function(a){var b,h,k,l,m=$(d).parents();for(l=f.menu_stack.length-1;0<=l;l--)k=f.menu_stack[l],b=$("#"+k),!b.is(":visible")||d==b.data("opener")||d==b.get(0)||m.is(b.data("opener"))||k==h||"true"==b.attr("data-editable")&&$(d).parents("#"+k).length||"true"==b.attr("data-sticky")&&rcube_mouse_is_over(a,
b.get(0))||f.hide_menu(k,a),h=b.data("parent")},10,a)}};this.doc_keypress=function(a){var b=function(a){var b,d=0>a?"prevAll":"nextAll",e=0>a?"last":"first";return f.focused_menu&&(b=$("#"+f.focused_menu))?(a=b.find(":focus").closest("li")[d](":has(:not([aria-disabled=true]))").find("a,input")[e](),a.length||(a=b.find(":focus").closest("ul")[d](":has(:not([aria-disabled=true]))").find("a,input")[e]()),a.focus().length):0},d=a.target||{},e=rcube_event.get_keycode(a);rcube_event._last_keyboard_event=
...
"loading"),a={_cid:g,_source:this.env.source,_to:b,_togid:a.id,_gid:e},this.http_post("copy",a,d)):a.id!=d&&(d=this.display_message(this.get_label("copyingcontact"),"loading"),a={_cid:g,_source:this.env.source,_to:a.id,_gid:e},this.http_post("copy",a,d)))};this.move_contacts=function(a){var b="group"==a.type?a.source:a.id,d=this.env.source;this.env.address_sources[b]&&!this.env.address_sources[b].readonly&&(""==d&&1==this.env.selection_sources.length&&(d=this.env.selection_sources[0]),"group"==a.type?
b!=d&&this._with_selected_contacts("move",{_to:b,_togid:a.id}):a.id!=d&&this._with_selected_contacts("move",{_to:a.id}))};this.delete_contacts=function(){if(this.env.source&&this.env.address_sources[this.env.source].undelete||confirm(this.get_label("deletecontactconfirm")))return this._with_selected_contacts("delete")};this._with_selected_contacts=function(a,b){var d=this.contact_list?this.contact_list.get_selection():[];if(d.length||this.env.cid){var e,g=[],f=this.display_message(this.get_label("delete"==
a?"contactdeleting":"movingcontact"),"loading");if(this.env.cid)g.push(this.env.cid);else{for(e=0;e<d.length;e++)id=d[e],g.push(id),this.contact_list.remove_row(id,e==d.length-1);1==d.length&&this.show_contentframe(!1)}b||(b={});b._source=this.env.source;b._from=this.env.action;b._cid=g.join(",");this.env.group&&(b._gid=this.env.group);this.env.search_request&&(b._search=this.env.search_request);this.http_post(a,b,f);return!0}};this.update_contact_row=function(a,b,d,e,g){var f=this.contact_list;a=
this.html_identifier(a);f.rows[a]||(a=a+"-"+e,d&&(d=d+"-"+e));f.update_row(a,b,d,!0);f.data[a]=g};this.add_contact_row=function(a,b,d,e){if(!this.gui_objects.contactslist)return!1;var g,f=this.contact_list,k={cols:[]};k.id="rcmrow"+this.html_identifier(a);k.className="contact "+(d||"");f.in_selection(a)&&(k.className+=" selected");for(g in b)d={},d.className=String(g).toLowerCase(),d.innerHTML=b[g],k.cols.push(d);f.data[a]=e;f.insert_row(k);this.enable_command("export",0<f.rowcount)};this.init_contact_form=
function(){var a;if(this.env.coltypes)for(a in this.set_photo_actions($("#ff_photo").val()),this.env.coltypes)this.init_edit_field(a,null);$(".contactfieldgroup .row a.deletebutton").click(function(){f.delete_edit_field(this);return!1});$("select.addfieldmenu").change(function(){f.insert_edit_field($(this).val(),$(this).attr("rel"),this);this.selectedIndex=0});$.datepicker&&this.env.date_format&&($.datepicker.setDefaults({dateFormat:this.env.date_format,changeMonth:!0,changeYear:!0,yearRange:"-120:+10",
...
k.className.match(/collapsed/))for(var l in this.env.unread_counts)l.startsWith(a+this.env.delimiter)&&(e+=this.env.unread_counts[l]);f&&d.length?d.html(this.env.unreadwrap.replace(/%[sd]/,f)):d.length&&d.remove();d=RegExp(RegExp.escape(this.env.delimiter)+"[^"+RegExp.escape(this.env.delimiter)+"]+$");a.match(d)&&this.set_unread_count_display(a.replace(d,""),!1);0<f+e?$(g).addClass("unread"):$(g).removeClass("unread")}d=/^\([0-9]+\)\s+/i;b&&document.title&&(g="",g=String(document.title),g=f&&g.match(d)?
...
k=document.createElement("a"),d=$('<div id="folder-selector" class="popupmenu"></div>');k.href="#";k.className="icon";$.each(this.env.mailboxes_list,function(){var a=0,b=0,d=f.env.mailboxes[this],h=d.id,q=$(k.cloneNode(!1)),s=$("<li>");d.virtual?q.addClass("virtual").attr("aria-disabled","true").attr("tabindex","-1"):q.addClass("active").data("id",d.id);for(d["class"]&&q.addClass(d["class"]);0<=(b=h.indexOf(g,b));)a++,b++;q.css("padding-left",a?16*a+"px":0);q.append($("<span>").text(d.name));s.append(q);
e.push(s)});h.append(e).appendTo(d);d.css({left:"-1000px",top:"-1000px"}).appendTo($("body")).show();10<e.length&&d.css("max-height",10*$("li",d)[0].offsetHeight+9);d.on("click","a.active",function(a){d.data("callback")($(this).data("id"));return!1});this.folder_selector_element=d}d.data("callback",b);this.show_menu("folder-selector",!0,a)};this.show_menu=function(a,b,d){var e="object"==typeof a?a.menu:a,g=$("#"+e),f=d&&d.target?$(d.target):$(g.attr("rel")||"#"+e+"link"),k=rcube_event.is_keyboard(d),
l=g.attr("data-align")||"",m=!1;"A"!=f.get(0).tagName&&f.closest("a").length&&(f=f.closest("a"));"string"==typeof a&&(a={menu:e});g.length||(g=this.triggerEvent("menu-get",{name:e,props:a,originalEvent:d}));if(!g||!g.length)return this.triggerEvent(!1===b?"menu-close":"menu-open",{name:e,props:a,originalEvent:d});g.appendTo(document.body);"undefined"==typeof b&&(b=g.is(":visible")?!1:!0);if(b&&f.length){var n=$(window),p=f.offset(),q=0<=l.indexOf("bottom"),m="menuitem"==f.attr("role")||0<f.closest("[role=menuitem]").length;
f.offsetWidth=f.outerWidth();f.offsetHeight=f.outerHeight();!q&&p.top+f.offsetHeight+g.height()>n.height()&&(q=!0);0<=l.indexOf("right")?p.left=p.left+f.outerWidth()-g.width():m&&(p.left=p.left+f.offsetWidth-5,p.top-=f.offsetHeight);p.left+g.width()>n.width()&&(p.left=n.width()-g.width()-12);p.top=Math.max(0,p.top+(q?-g.height():f.offsetHeight));g.css({left:p.left+"px",top:p.top+"px"})}if(b){for(l=this.menu_stack.length-1;m&&0<=l;l--)$(f).parents("#"+this.menu_stack[l]).length||"menuitem"==$(d.target).parent().attr("role")||
this.hide_menu(this.menu_stack[l],d);m&&this.menu_stack.length?(g.data("parent",$.last(this.menu_stack)),g.css("z-index",($("#"+$.last(this.menu_stack)).css("z-index")||0)+1)):!m&&this.menu_stack.length&&this.hide_menu(this.menu_stack[0],d);g.show().attr("aria-hidden","false").data("opener",f.attr("aria-expanded","true").get(0));this.triggerEvent("menu-open",{name:e,obj:g,props:a,originalEvent:d});this.menu_stack.push(e);if(this.menu_keyboard_active=b&&k)this.focused_menu=e,g.find("a,input:not(:disabled)").not("[aria-disabled=true]").first().focus()}else this.hide_menu(e,
